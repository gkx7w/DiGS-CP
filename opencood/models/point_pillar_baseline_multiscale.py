...
class PointPillarBaselineMultiscale(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # print("转换矩阵维度：",data_dict['pairwise_t_matrix'].shape,normalized_affine_matrix.shape)
        #
        # print("转换矩阵：",data_dict['pairwise_t_matrix'][0].sum(dim=[-1,-2]),normalized_affine_matrix[0].sum(dim=[-1,-2]))
        ...
        # print("feature shape: ",[t.shape for t in feature_list])
