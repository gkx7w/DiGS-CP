...
def getDecdiffusiondairFusionDataset(cls):
    class DecdiffusiondairFusionDataset(cls):
        """
        This dataset is used for early fusion, where each CAV transmit the raw
        point cloud to the ego vehicle.
        """
        def __init__(self, params, visualize, train=True):
            super(DecdiffusiondairFusionDataset, self).__init__(params, visualize, train)
        ...
        def __getitem__(self, idx):
            ...
            for _i, cav_id in enumerate(cav_id_list):
                ...
                projected_lidar_stack_multi.append(
            ...
            for boxes, points, id_index in zip(tmp_object_stack, projected_lidar_stack_multi, Multi_view_object_id_index):
    ...
    return DecdiffusiondairFusionDataset
