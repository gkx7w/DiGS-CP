...
class FpvrcnnLoss(nn.Module):
    def __init__(self, args):
        ...
        # 这个loss是需要指定的，从create_loss里面学习一下！
        self.ciassd_loss = train_utils.create_loss(hypes)
    ...
    def forward(self, output_dict, label_dict):
        ...
        if "mv_box_loss" in output_dict:
            rcnn_loss = loss_cls_reduced + loss_iou_reduced + loss_reg_reduced + output_dict['mv_box_loss'] + \
                        output_dict['cls_box_loss']
