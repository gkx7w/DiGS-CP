...
def train_parser():
    ...
    parser.add_argument("--hypes_yaml", "-y", type=str, default="/home/ypy/projects/CoAlign/opencood/hypes_yaml/opv2v/lidar_only_with_noise/pointpillar_disconet.yaml",
                        help='data generation yaml file needed ')
    parser.add_argument('--qkv', default='',
                        help='mark this process')

    parser.add_argument('--model_dir',
                        default='/home/ypy/projects/CoAlign/checkpoints/disconet/student/first_best',
